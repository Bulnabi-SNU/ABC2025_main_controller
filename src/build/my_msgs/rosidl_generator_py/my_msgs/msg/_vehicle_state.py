...
class VehicleState(metaclass=Metaclass_VehicleState):
    ...
    def __init__(self, **kwargs):
        ...
        self.substate = kwargs.get('substate', str())
    ...
    def __eq__(self, other):
        ...
        if self.state != other.state:
            return False
        if self.substate != other.substate:
            return False
        return True
    ...
    def substate(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'substate' field must be of type 'str'"
